...
if __name__ == "__main__":
    ...
    fusion_add_numsamples = (str(experiment_params["num_samples"]) if experiment_params["fusion_type"] != FusionType.WEIGHT else "")
    with open(
        f"./results_and_plots_o/fullDict_results_{experiment_params['fusion_type']}{fusion_add_numsamples}_{experiment_params['models'][0]['name']}/results_s{All}_re{experiment_params['num_epochs']}_wholeDataModel.json",
        "w",
    ) as outfile:
