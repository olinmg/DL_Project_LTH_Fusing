...
class OptimalTransport:
    ...
    def _cost(self, weights0, weights1):
        ...
        #distance = torch.cdist(weights0, weights1, p=self.p).cpu()
    ...
    def __call__(self, group, importance, pruning_idxs):
        ...
        for dep, idxs in group:
            ...
            if prune_fn in [
                ...
                if layer.bias != None:
                    ...
                    w = torch.cat((w, layer.bias.view(layer.bias.shape[0], -1)), dim=1)
                w_all.append(w)
            ...
            # in_channels
                ...
                if prune_fn == function.prune_linear_in_channels:
                    continue
                if hasattr(layer, "transposed") and layer.transposed:
        ...
        if self.target == "most_important":
            cost = []
            for w in w_all:
                cost.append(self._cost(w, w[keep_idxs]))
