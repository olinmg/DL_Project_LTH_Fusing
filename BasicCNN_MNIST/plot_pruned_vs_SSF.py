...
def plot_new():
    ...
    #plot(lines=[accuracy_pruned_fused_total-accuracy_pruned_total], x = x, labels=["SSF"], xlabel="Sparsity", ylabel="Accuracy Gain over Pruned")
    ...
    plot(lines=[accuracy_pruned_fused_total -accuracy_pruned_total], x = x, labels=["SSF"], xlabel="Sparsity", ylabel="Accuracy")
...
if __name__ == '__main__':
    ...
    accuracy_pruned_and_fused = [r["vgg11"]["model_0"]["accuracy_pruned_and_fused"]["0"] for r in results]
    ax.plot(x, accuracy_pruned_and_fused, label="accuracy_pruned_and_fused")

    accuracy_pruned = [r["vgg11"]["model_0"]["accuracy_pruned"]["0"] for r in results]
    ax.plot(x, accuracy_pruned, label="accuracy_pruned")

    accuracy_pruned_and_fused_multi = [r["vgg11"]["model_0"]["accuracy_pruned_and_fused_multiple_sparsities"]["0"] for r in results]
